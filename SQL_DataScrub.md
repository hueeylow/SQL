# SQL Project Demo - Data Wrangling
Welcome to my SQL project demo on how to do "data scrub" from downloaded source database.
<br>
<br>
Data wrangling is vital procedure in data analytics process because it improves the quality and accuracy of the data, when incorrect information is rectified, unused data and duplicates are removed. And of course, business decisions is always relying on accurate data as source of truth.
<br>
<br>
...
<br>
<br>
Compare both files of <a href="https://github.com/hueeylow/SQL/blob/main/netflix_titles_original.xls"> before </a> and <a href="https://github.com/hueeylow/SQL/blob/main/netflix_titles_cleaned.xls"> after </a> data cleaning. You will need to download the raw file to view the data.
<br>
<br>
